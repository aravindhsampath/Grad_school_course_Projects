...
public:
  ...
  float maxVelocityX() const { return maxVelocity[0]; }
  void maxVelocityX(float maxX) { maxVelocity[0] = maxX; }

  float maxVelocityY() const { return maxVelocity[1]; }
  void maxVelocityY(float maxY) { maxVelocity[1] = maxY; } 
